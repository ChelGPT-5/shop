    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Available', 'Available'), ('On Loan', 'On Loan'), ('Lost', 'Lost')], default='Available', max_length=15)),
                ...
                ('laguage', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catalog.language')),
            ],
        ),
        migrations.AddField(
            model_name='book',
