    ...
    def get_result_price(self, data):
        ...
        for item in data.get('products'):
            ...
            if item.get('discount'):
                ...
                date_end = item.fet('discount_date_end')
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ('created_at', 'promocode', 'delivery_time', 'delivery_notif_in_time',
                  'delivery_method', 'delivery_adress', 'delivery_status',
                  'payment_method', 'payment_statuses',
                  'result_price', 'products', 'use_cashback')
        read_only_fields = ('created_at', 'delivery-status', 'payment_statuses', 'result_price')
